function Figure06S_polarHistograms(glob, fPlots, data)
...
for l = 1:3
    ...
    h = [0 0];
    figure('Position', glob.figPositionDefault)
    histogram(errDir_original{l}, edges, "FaceColor", "k", "FaceAlpha", 1)
    hold on
    ...
    h = [0 0];
    figure('Position', glob.figPositionDefault)
    histogram(errOri_original{l}, edges, "FaceColor", "k", "FaceAlpha", 1)
    hold on
